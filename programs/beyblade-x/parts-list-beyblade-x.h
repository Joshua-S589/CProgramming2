...
char blade[121][50]={"Aether Ring", "Black Shell", "Cobalt Dragoon", "Cobalt Drake", "Crimson Garuda", "Croc Crunch", "Dran Dagger", "Dran Strike", "Dran Sword", "Hells Chain", "Hells Scythe", "Knight Lance", "Knight Shield", "Leon Claw", "Phoenix Feather", "Phoenix Wing", "Rhino Horn", "Samurai Calibur", "Shark Edge", "Shelter Drake", "Sphinx Cowl", "Tricera Press", "Tyranno Beat", "Unicorn Sting", "Viper Tail", "Weiss Tiger", "Whale Wave", "Wizard Arrow", "Wyvern Gale",
     ...
     "Blitz", "Delta", "Fortress", "Rage", "Whip"};
...
char lock_chip[23][50]={"Valkyrie", "Emperor", "Bahamut", "Brachio", "Cerberus", "Dran", "Eva", "Fox", "Hells", "Hornet", "Knight", "Kraken", "Pegasus", "Perseus", "Phoenix", "Ragna", "Rhino", "Sol", "Stag", "Unicorn", "Whale", "Wizard", "Wolf"};
char over_blade[5][50]={"B", "D", "F", "G", "O"};
