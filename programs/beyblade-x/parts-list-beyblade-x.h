...
char blade[109][50]={"Black Shell", "Cobalt Dragoon", "Cobalt Drake", "Crimson Garuda", "Dran Dagger", "Dran Sword", "Hells Chain", "Hells Scythe", "Knight Lance", "Knight Shield", "Leon Claw", "Phoenix Feather", "Phoenix Wing", "Rhino Horn", "Samurai Calibur", "Shark Edge", "Shelter Drake", "Sphinx Cowl", "Tricera Press", "Tyranno Beat", "Unicorn Sting", "Viper Tail", "Weiss Tiger", "Whale Wave", "Wizard Arrow", "Wyvern Gale",
     ...
     "Bite Croc", "Gill Shark", "Knife Shinobi", "Ridge Triceratops", "Roar Tyranno", "Savvage Bear", "Steel Samurai", "Tackle Goat", "Talon Ptera", "Tusk Mammoth", "Yell Kong",
...
int bladeCollection1[109];
int bladeCollectionClone1[109];
int assistBladeCollection1[13];
int assistBladeCollectionClone1[13];
int ratchetCollection1[35];
int ratchetCollectionClone1[35];
int bitCollection1[44];
int bitCollectionClone1[44];
int lockChipCollection1[14];
int lockChipCollectionClone1[14];
int bladeCollection2[109];
int bladeCollectionClone2[109];
int assistBladeCollection2[13];
int assistBladeCollectionClone2[13];
int ratchetCollection2[35];
int ratchetCollectionClone2[35];
int bitCollection2[44];
int bitCollectionClone2[44];
