...
int main(void){
    ...
    if(battleChoice=='B'){
        ...
        runBattle();
        for(int a=0;a<1;){
            printf("Would you like to continue to run battles? Y/N ");
            scanf(" %c", &playerChoice);
            while(!(playerChoice=='Y'||playerChoice=='N')){
                puts("\nSorry, that is an invalid command. Please reenter");
                printf("Would you like to continue to run battles? Y/N ");
                scanf(" %c", &playerChoice);
            }
            if(playerChoice=='Y'){
                printf("\nWould you like to keep with the same players (S), or generate decks under different players (D)? ");
                scanf(" %c", &playerChoice);
                while(!(playerChoice=='S'||playerChoice=='D')){
                    puts("\nSorry, that is an invalid command. Please reenter");
                    printf("Would you like to keep with the same players (S), or generate decks under different players (D)? ");
                    scanf(" %c", &playerChoice);
                }
                if(playerChoice=='S'){
                    runBattle();
